...
{
  usMotor_Status = CW;
  motorGo(MOTOR_1, usMotor_Status, 230);
  motorGo(MOTOR_2, usMotor_Status, 230);
  motorGo(MOTOR_3, usMotor_Status, 150);
  motorGo(MOTOR_4, usMotor_Status, 150);
}
...
void Forward() //changed
{
  ...
  motorGo(MOTOR_2, usMotor_Status, 150);
  motorGo(MOTOR_3, usMotor_Status, 150);
  motorGo(MOTOR_4, usMotor_Status, 150);
}
...
void Left() //changed
{
  ...
  motorGo(MOTOR_1, usMotor_Status, 150);
  motorGo(MOTOR_2, usMotor_Status, 150);
  motorGo(MOTOR_3, usMotor_Status, 230);
  motorGo(MOTOR_4, usMotor_Status, 230);
}
...
void RRight() //was RRight()
{

  motorGo(MOTOR_1, CCW, 180);
  motorGo(MOTOR_2, CCW, 180);
  motorGo(MOTOR_3, CW, 180);
  motorGo(MOTOR_4, CW, 180);
}

void LLeft() //was LLeft()
{

  motorGo(MOTOR_1, CW, 180);
  motorGo(MOTOR_2, CW, 180);
  motorGo(MOTOR_3, CCW, 180);
  motorGo(MOTOR_4, CCW, 180);
}
void Reverse()
{
  usMotor_Status = CW;
...
void FirstBigLoop() {
  ...
  else if ( Dloop == 500 ) { //trying to find the tag if it cant find it for 300 loops loop = loop + 1 at magnetometer line section
    Swivel();
    Dloop = 0;
  }
  else {
